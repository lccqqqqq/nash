#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue 23 Dec 23:50:57 GMT 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 100 --mpi=pmix --mem-per-cpu=921 nice -n 10 /usr/bin/python3 experiments/gather_equilibrium_stats.py --num-players 6 --chi 8 --num-samples 200 --save-dir data/equilibrium_stats/chi8 --verbose --max-iter 1000 --alpha 0.06 --convergence-threshold 1e-6 --expl-threshold 1e-3
  echo ---------------                                           
