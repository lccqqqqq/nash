#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Tue 23 Dec 14:05:27 GMT 2025      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 1 --mpi=pmix --mem-per-cpu=1024 nice -n 10 /usr/bin/python3 solver.py
  echo ---------------                                           
