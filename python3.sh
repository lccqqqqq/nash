#!/bin/bash -l
echo =========================================================   
echo Job submitted  date = Thu  5 Feb 16:58:09 GMT 2026      
date_start=`date +%s`
...
export OMP_NUM_THEADS=1
 /usr/local/shared/slurm/bin/srun -u -n 10 --mpi=pmix --mem-per-cpu=1024 nice -n 10 /usr/bin/python3 ghz_local_optimality.py --eps 1.0 --n-samples 10
  echo ---------------                                           
